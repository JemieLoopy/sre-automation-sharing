...
### How to
Requirement Tools:
 - Client Tools in your PC: kubectl, helm, helmfile, helmdiff plugin, git ![alt text](https://github.com/JemieLoopy/sre-automation-sharing/tree/main/requirement-tools)
